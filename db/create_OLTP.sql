-- This SQL script creates a new database named tote_OLTP_db and several tables within it.
-- The tables are used to store data for an OLTP system.

DROP DATABASE IF EXISTS tote_OLTP_db;
CREATE DATABASE tote_oltp_db;
